 ...
 * Description:
 *
 * This file is no longer accurate and no longer used EXCEPT that the wifi
 * code refers to some of the items here and so these files are required when
 * building from source.  It is easier to keep them than to change the wifi
 * code.
 *
 ****************************************************************************/
#ifndef _BOARD_H
...
// This is no longer used - but included becasue vestigial WiFi code still refers to it
typedef enum
{
    NVRAM,
    VOID
